...
public class BusinessSteps extends BaseSteps {
    ...
    public void popupIsOpen() {
        boolean isOpen = businessPage.waitPopupOpen();
    ...
    public void popupHaveDocumentName() throws Exception {
        ...
        String name = apiUserDetailsService.getUserDetail().ecCods.stream()
                ...
                .findFirst()
                .orElseThrow();
        int numberOfElementsInsidePopup = businessPage.numberOfElementsWithText(name);
    ...
    public void popupHaveCnpj() throws Exception {
        ...
        int expectedElements = apiUserDetailsService.getEcsFromDoc(selectECOrDtcoPage.getSelectedDoc()).size();
        int numberOfElementsInsidePopup = businessPage.numberOfElementsWithText(formattedCnpj);
    ...
    public void popupHaveEcs() throws Exception {
        ...
        for (String ec : expectedEcs) {
            int numberOfElementsInsidePopup = businessPage.numberOfElementsWithText(ec);
    ...
    public void openPopup() {
        businessPage.openPopupChangeEstablishment();
    }

    @Then("Popup terá mesmo ECs que o selecionado")
    public void popupSameEc() {
        String expectedEc = selectECOrDtcoPage.getSelectedEc();
        int numberOfElementsInsidePopup = businessPage.numberOfElementsWithText(expectedEc);
    ...
    public void selectEc() {
        ...
        boolean isClosed = businessPage.waitPopupClose();
