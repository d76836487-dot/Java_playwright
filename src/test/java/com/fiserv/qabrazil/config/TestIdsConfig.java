...
public class TestIdsConfig {
    private static final Map<String, String> testIdMaps = Map.<String, String>ofEntries(
            ...
            entry("Header - Trocar Estabelecimento - Modal - Visualizar Documentos", "alterar-matriz-type-documento"),
    ...
    private static final Map<String, String> otherSelectors = Map.ofEntries(
            ...
            entry("Modal Gerar Relatórios - Título", "[role=dialog] h1"),
            entry("Modal Gerar Relatórios - Descrição", "[role=dialog] p"),
            entry("Modal Gerar Relatórios - Estabelecimento Comercial", "//div[@role='dialog']//div[@data-container][.//div[@class='OSBlockWidget']]//span[@class='bold']//span"),
            entry("Modal Gerar Relatórios - CPF ou CNPJ", "//div[@role='dialog']//div[@data-container][.//div[@class='OSBlockWidget']]//span[not(@class='bold')]//span"),
            ...
            entry("Modal Gerar Relatórios - Select EC Selecionado", "//div[@role='dialog']//div[@data-block='AppAntecipacao.SimpleDropdownSelect'][.//span[starts-with(text(), 'Estabelecimento')]]//div[@class='om-input-select']//span[not(starts-with(text(), 'Estabelecimento'))]"),
            entry("Modal Gerar Relatórios - Select EC Opções", "//div[@role='dialog']//div[@data-block='AppAntecipacao.SimpleDropdownSelect'][.//span[starts-with(text(), 'Estabelecimento')]]//div[@class='om-dropdown-select-item']"),
            ...
            entry("Modal Gerar Relatórios - Select Tipo Selecionado", "//div[@role='dialog']//div[@data-block='AppAntecipacao.SimpleDropdownSelect'][.//span[starts-with(text(), 'Tipo de relat')]]/span"),
            entry("Modal Gerar Relatórios - Select Tipo Opções", "//div[@role='dialog']//div[@data-block='AppAntecipacao.SimpleDropdownSelect'][.//span[starts-with(text(), 'Tipo de relat')]]//div[@class='om-dropdown-select-item']"),
            entry("Modal Gerar Relatórios - Select Período Label", "//div[@role='dialog']//div[@data-block='AppAntecipacao.DateInputPickerRange'][.//span[starts-with(text(), 'Período')]]//label/span"),
            entry("Modal Gerar Relatórios - Select Período Selecionado", "//div[@role='dialog']//div[@data-block='AppAntecipacao.DateInputPickerRange'][.//span[starts-with(text(), 'Período')]]/span"),
            entry("Modal Gerar Relatórios - Select Período Opções", "//div[@role='dialog']//div[@data-block='AppAntecipacao.DateInputPickerRange'][.//span[starts-with(text(), 'Período')]]//div[@class='om-dropdown-select-item']"),
