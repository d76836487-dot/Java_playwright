...
public class TestIdsConfig {
    private static final Map<String, String> testIdMaps = Map.<String, String>ofEntries(
            ...
            entry("Modal Gerar Relatórios - Select Tipo Arquivo Selecionado", "simple-dropdown-select-formato-arquivo-text-selected"),
            entry("Modal Gerar Relatórios - Select Tipo Arquivo Opções", "simple-dropdown-select-formato-arquivo-item.*"),
