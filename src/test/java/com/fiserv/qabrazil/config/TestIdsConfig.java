...
public class TestIdsConfig {
    private static final Map<String, String> testIdMaps = Map.<String, String>ofEntries(
            ...
            entry("Home - Agenda Recebimento - Mes Segunda", "home-card-recebimentos-semana-text-mes-segunda"),
            entry("Home - Agenda Recebimento - Sei La O Que Segunda", "home-card-recebimentos-semana-text-segunda"),
            entry("Home - Agenda Recebimento - Valor Segunda", "home-card-recebimentos-semana-text-segunda-valor"),
            entry("Home - Agenda Recebimento - Qtd Depositos Segunda", "home-card-recebimentos-semana-text-segunda-qtd-depositos"),
            entry("Home - Agenda Recebimento - Dia Terca", "home-card-recebimentos-semana-text-dia-terca"),
            entry("Home - Agenda Recebimento - Mes Terca", "home-card-recebimentos-semana-text-mes-terca"),
            entry("Home - Agenda Recebimento - Sei La O Que Terca", "home-card-recebimentos-semana-text-terca"),
            entry("Home - Agenda Recebimento - Valor Terca", "home-card-recebimentos-semana-text-terca-valor"),
            entry("Home - Agenda Recebimento - Qtd Depositos Terca", "home-card-recebimentos-semana-text-terca-qtd-depositos"),
            entry("Home - Agenda Recebimento - Dia Quarta", "home-card-recebimentos-semana-text-dia-quarta"),
            entry("Home - Agenda Recebimento - Mes Quarta", "home-card-recebimentos-semana-text-mes-quarta"),
            entry("Home - Agenda Recebimento - Sei La O Que Quarta", "home-card-recebimentos-semana-text-quarta"),
            entry("Home - Agenda Recebimento - Valor Quarta", "home-card-recebimentos-semana-text-quarta-valor"),
            entry("Home - Agenda Recebimento - Qtd Depositos Quarta", "home-card-recebimentos-semana-text-quarta-qtd-depositos"),
            entry("Home - Agenda Recebimento - Dia Quinta", "home-card-recebimentos-semana-text-dia-quinta"),
            entry("Home - Agenda Recebimento - Mes Quinta", "home-card-recebimentos-semana-text-mes-quinta"),
            entry("Home - Agenda Recebimento - Sei La O Que Quinta", "home-card-recebimentos-semana-text-quinta"),
            entry("Home - Agenda Recebimento - Valor Quinta", "home-card-recebimentos-semana-text-quinta-valor"),
            entry("Home - Agenda Recebimento - Qtd Depositos Quinta", "home-card-recebimentos-semana-text-quinta-qtd-depositos"),
            entry("Home - Agenda Recebimento - Dia Sexta", "home-card-recebimentos-semana-text-dia-sexta"),
            entry("Home - Agenda Recebimento - Mes Sexta", "home-card-recebimentos-semana-text-mes-sexta"),
            entry("Home - Agenda Recebimento - Sei La O Que Sexta", "home-card-recebimentos-semana-text-sexta"),
            entry("Home - Agenda Recebimento - Valor Sexta", "home-card-recebimentos-semana-text-sexta-valor"),
            entry("Home - Agenda Recebimento - Qtd Depositos Sexta", "home-card-recebimentos-semana-text-sexta-qtd-depositos"),
