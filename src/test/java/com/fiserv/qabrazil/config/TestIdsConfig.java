...
public class TestIdsConfig {
    private static final Map<String, String> testIdMaps = Map.<String, String>ofEntries(
            ...
            entry("Modal Gerar Relatórios - Select EC Label", "simple-dropdown-select-ecs-text-label"),
    ...
    private static final Map<String, String> otherSelectors = Map.<String, String>ofEntries(
            ...
            entry("Agenda de Recebimentos por UR - legenda gráfico Totais - cor Mastercard", "//*[local-name()='text'][starts-with(text(),'Mastercard')]/../*[local-name()='rect']"),
            entry("Agenda de Recebimentos por UR - legenda gráfico Totais - cor Amex", "//*[local-name()='text'][starts-with(text(),'Amex')]/../*[local-name()='rect']"),
            entry("Agenda de Recebimentos por UR - legenda gráfico Totais - cor Cabal", "//*[local-name()='text'][starts-with(text(),'Cabal')]/../*[local-name()='rect']"),
            entry("Agenda de Recebimentos por UR - legenda gráfico Totais - texto ELO", "//*[local-name()='text'][starts-with(text(),'ELO')]"),
            entry("Agenda de Recebimentos por UR - legenda gráfico Totais - texto Visa", "//*[local-name()='text'][starts-with(text(),'Visa')]"),
            entry("Agenda de Recebimentos por UR - legenda gráfico Totais - texto Hipercard", "//*[local-name()='text'][starts-with(text(),'Hipercard')]"),
