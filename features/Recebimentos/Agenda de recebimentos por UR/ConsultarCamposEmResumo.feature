...
#
#
#QScenario: Consultar Pagamentos da UR (Status Programado)
#  Given Usuário está na tela “Agenda de recebimentos por UR / Detalhe da UR”
#  When Usuário clicar na aba Pagamentos
...
#
#
#QScenario: Consulta de campo Valor total Líquido, soma do Valor de Bandeiras
#
#  Given Usuário está logado em Agenda de recebimentos por UR
#  When Usuário Está em Resumo, Totais Líquidos Por Bandeira.
#  Then Usuário deve visualizar se Somando valor das Bandeiras Confere com valor Líquido (abaixo do Gráfico).
#
#
#QScenario: Consultar detalhe da UR por dia / “Total antecipação Automática”
#  Given Usuário está logado em Agenda de recebimentos por UR
#  When Usuário Está em Resumo, Total de Entradas e Saídas
#  Then Usuário visualizara o item “Total antecipação automática”
#
#
#
#QScenario: Consultar detalhe da UR por dia / Antecipação Automática sem Saldo
#  Given Usuário está logado em Agenda de recebimentos por UR
#  When Usuário Está em Resumo, Total de Entradas e Saídas
#  Then Usuário visualizara no detalhe os lançamentos da UR/ Antecipação
#  And e o valor deve ser informado “0,00”
#
#
#QScenario: Consultar detalhe da UR por dia / Antecipação Automática Com Saldo
#  Given Usuário está logado em Agenda de recebimentos por UR
#  When Usuário visualiza Total de Entradas e Saídas
#  Then Usuário visualizara no detalhe os lançamentos da UR, Antecipação
#  And e o valor deve ser informado diferente de “xx,xx”
#
#QScenario: Consultar detalhe da UR por dia / Total antecipação Eventual Sem Saldo
# Given Usuário está logado em Agenda de recebimentos por UR
# When Usuário visualiza Total de Entradas e Saídas
# Then Usuário visualizara no detalhe os lançamentos da UR, Antecipação eventual
# And e o valor deve ser informado “0,00”
#
#QScenario: Consultar detalhe da UR por dia / Total antecipação Eventual Com Saldo
# Given Usuário está logado em Agenda de recebimentos por UR
# When Usuário visualiza Total de Entradas e Saídas
#  Then Usuário visualizara no detalhe os lançamentos da UR, Antecipação eventual
#  And e o valor deve ser informado diferente de “xx,xx”
