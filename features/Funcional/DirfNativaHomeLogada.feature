...
Feature: Dirf Nativa Home Logada
  ...
  Scenario Outline: Acessar o menu Informe de Rendimento a partir do acesso rápido da home logada (personalizada)
  ...
  Scenario Outline: Acessar o menu Informe de Rendimento a partir do rodapé
    Given que o usuário está logado na home
  ...
  Scenario Outline: Exibir mensagem correta no subtítulo da tela de Informe de Rendimentos
  ...
  Scenario Outline: Cliente vê anos por default ao clicar no accordion
  ...
  Scenario Outline: Cliente seleciona um EC e um ano com DIRF disponível
    Given que o cliente está na página de extração de DIRF
  ...
  Scenario Outline: Cliente seleciona um EC e um ano sem DIRF disponível
    Given que o cliente está na página de extração de DIRF
    When o cliente seleciona o EC no componente troca de estabelecimento
    And o cliente expande o accordion para selecionar o ano da DIRF
    Then os anos de "2020", "2021", "2022", "2023" e "2024" são exibidos por padrão
  ...
  Scenario Outline: Baixar DIRF em PDF com loading no botão
    Given que o cliente está na página de extração de DIRF
  ...
  Scenario Outline: Validando nome do Arquivo PDF
  ...
  Scenario Outline: Cliente seleciona um EC e um ano sem resultados de DIRF
    Given que o cliente está na página de extração de DIRF
    And o cliente selecionou um EC válido
  ...
  Scenario Outline: Exibir mensagem de erro se o download falhar
    Given que o cliente está na página de extração de DIRF
  ...
  Scenario Outline: Fechar modal usando o botão "x"
  ...
  Scenario Outline: Fechar modal usando o botão "Fechar"
    Given que o cliente está na tela do modal de DIRF
    And o cliente havia selecionado o ano "2022"
