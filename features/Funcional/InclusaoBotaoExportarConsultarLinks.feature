...
Feature: Inclusao do Botao Exportar para aba Consultar links
  ...
  Scenario: Validando Arquivo CSV
    ...
    Then ele deve estar com o seguinte nome: Relatorio_de_consulta_link_de_pagamento
    #_DD-MM-AA_HHMM.
  ...
  Scenario: Validando Arquivo Excel
    ...
    Then ele deve estar com o seguinte nome: Relatorio_de_consulta_link_de_pagamento
    #_DD-MM-AA_HHMM.
    And conterá as seguintes informações: Relatório de Consulta Link de Pagamento, Período de Consulta
    #: DD/MM/AA à DD/MM/AA , Emitido em: DD/MM/AA HH/MM:SS Estabelecimento comercial:
