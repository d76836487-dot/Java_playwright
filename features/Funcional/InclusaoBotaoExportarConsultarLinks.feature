...
Feature: Inclusao do Botao Exportar para aba Consultar links
  ...
  Scenario: Login EC Link de Pagamento ou Com Links ja criado
  ...
  Scenario: Login EC Link de Pagamento ou Sem Link criado
    Given usuário fizer Login com Doc e Senha
  ...
  Scenario: Modal para selecao de Arquivo
  ...
  Scenario: Validando Arquivo Excel
    ...
    When ele abrir o arquivo
    Then ele deve estar com o seguinte nome: Relatorio_de_consulta_link_de_pagamento_DD-MM-AA_HHMM.
    And conterá as seguintes informações: Relatório de Consulta Link de Pagamento, Período de Consulta: DD/MM/AA à DD/MM/AA , Emitido em: DD/MM/AA HH/MM:SS Estabelecimento comercial:
  ...
  Scenario: Fechando Modal pelo Botao X
