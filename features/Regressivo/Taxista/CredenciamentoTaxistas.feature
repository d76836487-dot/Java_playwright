...
@Zephyr:Folder=/Portal_do_Cliente/Regressivo/Credenciamento_de_Taxistas
...
Feature: Credenciamento de Taxistas
  ...
  Scenario Outline: Realizar Cadastro do Credenciamento de Taxista
    ...
    Examples:
      | NomeCompleto        | DataNascimento | Celular       | Email                            | CPF           | NomeFantasia            | FaturamentoAnual | TicketMedio | ProdutosAzulzinha | Cep        | Logradouro      | SemNumero | Numero | Complemento   | Bairro   | Cidade           | Estado           | PontoReferencia       | AlterarNegocio1 | AlterarDadosPessoais1 | TipoConta | Agencia | Operacao | Conta       | AlterarNegocio2 | AlterarDadosPessoais2 | ExpandirEndereco | AlterarSobreVoce | AlterarSobreSeuNegocio | AlterarEndereco | AlterarContaRecebimento |
      | "Max Bezerra Silva" | "03031995"     | "11911112222" | "joao_taxista_teste02@gmail.com" | "43731117827" | "João Taxista Teste 02" | "9000000"        | "7500"      | "aproxima"        | "20230010" | "Rua Riachuelo" | "N"       | "333"  | "Complemento" | "Centro" | "Rio de Janeiro" | "Rio de Janeiro" | "Ponto de referência" | "N"             | "N"                   | "C"       | "22660" | "01"     | "000202771" | "N"             | "N"                   | "S"              | "N"              | "N"                    | "N"             | "N"                     |

    Examples:
      | NomeCompleto        | DataNascimento | Celular       | Email                            | CPF           | NomeFantasia            | FaturamentoAnual | TicketMedio | ProdutosAzulzinha | Cep        | Logradouro      | SemNumero | Numero | Complemento   | Bairro   | Cidade           | Estado           | PontoReferencia       | AlterarNegocio1 | AlterarDadosPessoais1 | TipoConta | Agencia | Operacao | Conta           | AlterarNegocio2 | AlterarDadosPessoais2 | ExpandirEndereco | AlterarSobreVoce | AlterarSobreSeuNegocio | AlterarEndereco | AlterarContaRecebimento |
      | "Max Bezerra Silva" | "03031995"     | "11911112222" | "joao_taxista_teste03@gmail.com" | "43731117827" | "João Taxista Teste 03" | "18000000"       | "1500000"   | "pro"             | "20230010" | "Rua Riachuelo" | "N"       | "333"  | "Complemento" | "Centro" | "Rio de Janeiro" | "Rio de Janeiro" | "Ponto de referência" | "N"             | "N"                   | "P"       | "00040" | "1288"   | "0202199000041" | "N"             | "N"                   | "S"              | "N"              | "N"                    | "N"             | "N"                     |
