...
Feature: Link de Pagamento
  ...
  Scenario: 5.1. Selecionar no header "todos os documentos" e ao menos um documento possuir EC de link de pagamento
    Given usuário esteja em Link de pagamento
  ...
  Scenario: 5.3 Comportamento do botão Trocar estabelecimento
  ...
  Scenario: 6. Layout do Link de pagamento aba Criar Link
  ...
  Scenario: 6.1 Apresentar termos e condições
  ...
  Scenario: 6.2 Layout termos e condições
    Given usuário nunca deu o aceite aos termos e condições anteriormente (pelo App ou Portal)
  ...
  Scenario: 7. Fechar Termos e Condições
  ...
  Scenario: 7.1 Aceite atraves da jornada de Link único
  ...
  Scenario: 7.2 Aceite atraves da jornada de Link recorrente
  ...
  Scenario: 8.Termos e Condições li e aceito
  ...
  Scenario: 8.1. Layout link único pagamento a vista
  ...
  Scenario: 8.2. Layout link único pagamento com parcelamento
    Given usuário seleciona Solicitar link de pagamento único
  ...
  Scenario: 8.3 Tooltip Parceldo lojista
    Given usuário seleciona Solicitar link de pagamento único
    When Preencher Descrição, valor e número de parcelas (de 2x em diante)
  ...
  Scenario: 8.4 Tooltip Parceldo emissor
    Given usuário seleciona Solicitar link de pagamento único
    When Preencher Descrição, valor e número de parcelas (de 2x em diante)
  ...
  Scenario: 9. Resumo da Venda Parcelado lojista
    Given usuário seleciona Solicitar link de pagamento único
  ...
  Scenario: 9.1 Resumo da venda Parcelado emissor
    Given usuário seleciona Solicitar link de pagamento único
  ...
  Scenario: 10. Resumo Dados da Venda Crédito a Vista
    Given usuário seleciona Solicitar link de pagamento único
    When Preencher Descrição, valor e número de parcelas (crédito a vista)
    And selecionar continuar
  ...
  Scenario: 11. Gerar Link de pagamento único Parcelado emissor
    Given usuário seleciona Solicitar link de pagamento único
  ...
  Scenario: 11.1 Gerar Link de pagamento único Parcelado lojista
    Given usuário seleciona Solicitar link de pagamento único
  ...
  Scenario: 12. Gerar link de pagamento único a vista
    Given usuário seleciona Solicitar link de pagamento único
  ...
  Scenario: 13. Check box texto copiado
  ...
  Scenario: 13.1 Check box texto copiado colando com sucesso
    Given Link de pagamento criado com sucesso !
    When Clicar no icone de copiar no Link gerado
  ...
  Scenario: 14. Erro ao Salvar Gerar link
  ...
  Scenario: 18.1 Editar Link de Pagamento único Parcelado Emissor
    Given usuário esteja na tela de Resumo
    When Selecionar o botão ‘’Editar’’
  ...
  Scenario: 18.2 Editar Link de Pagamento único Credito a vista
    Given usuário esteja na tela de Resumo
    When Selecionar o botão ‘’Editar’’
  ...
  Scenario: 19. Você ainda não criou um link
  ...
  Scenario: 20.1 Filtros rápidos calendário
  ...
  Scenario: 20.2 Range do calendário
    Given usuário esteja na aba Consultar Links
    When clicar no componente do calendário
    Then conseguira buscar por no máximo 31 dias corridos

  @TestCaseKey=LPDC-T540
  Scenario: 21. Detalhe do link de pagamento (autorizado)
    Given usuário esteja na aba Consultar links
  ...
  Scenario: 21.1 Detalhe do link de pagamento (autorizado)
  ...
  Scenario: 21.2 Detalhe do link de pagamento (ativo)
    Given usuário esteja na aba Consultar links
  ...
  Scenario: 22.1 Detalhe do link de pagamento (Negado)
    Given usuário esteja em em Link de pagamentos
    When Selecionar Consultar Links
  ...
  Scenario: 23. Detalhe do link de pagamento (Estornado)
    Given usuário esteja em em Link de pagamentos
    When Selecionar Consultar Links
  ...
  Scenario: 24. Detalhe do link de pagamento (pago)
    Given usuário esteja em em Link de pagamentos
    When Selecionar Consultar Links
  ...
  Scenario: 25. Detalhe do link de pagamento (Agendado)
    Given usuário esteja em em Link de pagamentos
    When Selecionar Consultar Links
  ...
  Scenario: 26. Comprovante de venda (pago)
  ...
  Scenario: 27. Comprovante de venda (agendado)
    Given usuário esteja no Detalhe do link de pagameto
    When clicar em comprovante
    Then visualizara comprovante de venda com Razão social cnpj ,
    Then ec e Emitido em (dd/mm/aaaa as hh:mm) ,Informações gerais
  ...
  Scenario: 29. Validar filtros rápido Links únicos
    Given usuário esteja em em Link de pagamentos
    When Selecionar Consultar Links
  ...
  Scenario: 29.1 Validar filtros rápido Links recorrentes
    Given usuário esteja em em Link de pagamentos
    When Selecionar Consultar Links
