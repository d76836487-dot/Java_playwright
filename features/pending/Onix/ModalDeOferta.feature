...
@Zephyr:Folder=/Portal_do_Cliente/Pending/Onix/Modal_de_Oferta
...
Feature: Modal de Oferta
  ...
  Scenario: Exibição de modal de Habilitação Conta Pix - Segundo acesso e usuario elegivel
    Given que tenho EC "Matriz" com o Perfil "Master"
