...
@Zephyr:Folder=/Portal_do_Cliente/Pending/Transacoes_tokenizadas/Pre-autorizacoes
@Zephyr:Status=Approved
@Zephyr:Priority=Low
Feature: Pre-autorizacoes

  @TestCaseKey=LPDC-T196
